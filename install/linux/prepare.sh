...
cp -v /usr/local/lib/libfedlibrary-3.0.2.so        ./lib/
cp -v /usr/local/lib/liblibavcpp-3.2.0.so          ./lib/
cp -v /usr/local/lib/libfedlibrary-3.0.2-debug.so  ./lib/
cp -v /usr/local/lib/liblibavcpp-3.2.0-debug.so    ./lib/
